...
TEST(ray2d_test, test_contruction)
{
  ...
  Ray2D r3 = { Point2D(1.0f, 1.0f),
               Point2D(1.0f, 1.0f) };
  r3 = std::move(r1);
  Point2D v1 = { 1.0f, 1.0f };
  v1.Normalize();
  EXPECT_EQ(r3.GetOrigin(), Point2D(0.0f, 0.0f));
  EXPECT_EQ(r3.GetDirection(), Point2D(0.0f, 0.0f));
  ...
  EXPECT_EQ(r2.GetDirection(), Point2D(0.0f, 0.0f));
}
...
TEST(ray2d_test, test_intersection)
{
  ...
  Ray2D r2 = Ray2D(Point2D(5.0f, 9.0f), Point2D(0.0f, -1.0f));
  ...
  Ray2D r3 = Ray2D(Point2D(5.0f, 9.0f), Point2D(1.0f, 1.0f));
  ...
  Ray2D  r4 = Ray2D(Point2D(5.0f, 9.0f), Point2D(-1.0f, -1.0f));
  ...
  Ray2D r5 = Ray2D(Point2D(5.0f, 9.0f), Point2D(0.0f, 1.0f));
